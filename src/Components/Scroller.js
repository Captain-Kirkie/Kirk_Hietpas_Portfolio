...
const Scroller = () => {
    return (
        <div className="flex-center">
            <ScrollerListItem
                imgSrc={
                    "https://storage.googleapis.com/portfolio_images_kh/repel.jpg"
                }
            ...
            <ScrollerListItem
                imgSrc={
                    "https://storage.googleapis.com/portfolio_images_kh/running-mtns.jpg"
                }
            ...
            <ScrollerListItem
                imgSrc={
                    "https://storage.googleapis.com/portfolio_images_kh/skiing.jpg"
                }
